                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col">
                                            ...
                                            <select class="form-select" name="rol" id="rol">
                                                <option value="usuario" {{ $usuario->rol == 'usuario' ? 'selected' : null }}>usuario</option>
                                                <option value="administrador" {{ $usuario->rol == 'administrador' ? 'selected' : null }}>Administrador</option>
                                            </select>
                                        </div>
                                    </div>
